            ...
            <div class="top-grids">
                ...
                <div class="col-md-4 resent-grid recommended-grid slider-top-grids">
                    <div class="resent-grid-img recommended-grid-img">
                        {{-- 图片地址--}}
                        <a href="{{ url('info', $movie->id) }}"><img src="{{ asset('images/t1.jpg') }}" alt="" /></a>
                        <div class="time">
                            {{-- 视频时长 --}}
                            <p>3:04</p>
                        </div>
                    ...
                    <div class="resent-grid-info recommended-grid-info">
                        {{-- 电影的标题 --}}
                        <h3><a href="{{ url('info', $movie->id) }}" class="title title-info">{{ $movie->name }}</a></h3>
                        <ul>
                            {{-- 视频作者--}}
                            <li><p class="author author-info"><a href="#" class="author">{{ $movie->director }}</a></p></li>

                            {{-- 视频的播放次数 --}}
                            <li class="right-list"><p class="views views-info">{{ $movie->hits }} views</p></li>
                        </ul>
                    </div>
                </div>
                @endforeach
